...
This repository contains programs written for the low-level programming. In these projects, which  occurred
throughout the duration of the Year 1 curriculum, I learned about data low-level programming concepts while
...
* [0x10. C - printf](https://github.com/DanielTolera/printf/tree/master)
...
* [0x15. C - Simple Shell](https://github.com/DanielDinka/simple_shell/tree/master)
* [0x16. C - Doubly linked lists](./0x16-doubly_linked_lists)
* [0x17. C - Dynamic libraries](./0x17-dynamic_libraries)
* [0x18. C - Stacks, Queues - LIFO, FIFO](https://github.com/DanielDinka/monty/tree/master)
